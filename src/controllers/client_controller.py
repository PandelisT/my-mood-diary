...
def clients_create():
    ...
    if not is_client:
        ...
        user.client_id.append(new_client)

        # here, user = defined above
        # client_id is linked as relationship to user: client_id = db.relationship("Client", backref=backref("users", uselist=False)) in users table
